function addTimeAndDuration() {
            var time1 = document.getElementById("time1").value; // First time in AM/PM format
            var time2 = document.getElementById("time2").value; // Second time in hh:mm:ss format
            ...
            //var output = ampm + ' ' + pad(hours) + ':' + pad(minutes);
            var output = pad(hours) + ':' + pad(minutes) + ' ' + ampm;
            // Display the result
            document.getElementById("result").innerHTML = "The sum is: " + output;
        }
